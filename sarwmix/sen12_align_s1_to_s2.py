...
def main():
    parser = argparse.ArgumentParser(description="Create SEN12FLOOD aligned dataset.")
    parser.add_argument("--dataset-root", required=True, type=str, help="Path to SEN12FLOOD dataset root.")
    parser.add_argument("--save-root", required=True, type=str, help="Path to save aligned data (alignment of Sentinel-1 to match Sentinel-2).")
    args = parser.parse_args()
    # Define paths
    dataset_root = args.dataset_root
    aligned_dataset_root = args.save_root
    os.makedirs(aligned_dataset_root, exist_ok=True)  # ensures the dir exists
